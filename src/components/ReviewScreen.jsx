...
export default function ReviewScreen({ tick, onEdited }) {
  ...
  return (
    <div>
      {unclaimed > 0 && <div className="warn-box" style={{ marginBottom:14 }}><strong>{unclaimed} entries</strong> have no collector name. Click each entry to set "Collected by: {DEFAULT_COLLECTOR}".</div>}
