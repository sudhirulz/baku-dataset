      ...
      <div style={{ display: 'flex', gap: 12, padding: '12px 16px', alignItems: 'flex-start' }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', fontSize: 11, marginBottom: 8, color: 'var(--text2)' }}>
            ...
            {isYT && captionWordCount > 0 && <span style={{ color: 'var(--green)', fontWeight: 500 }}>✓ {captionWordCount} words of captions ready</span>}
            {isYT && captionWordCount === 0 && <span style={{ color: 'var(--red)', fontWeight: 500 }}>⚠ No caption text — go to Upload tab</span>}
          ...
          <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
            <button className="btn btn-primary btn-sm" onClick={run} disabled={running || (isYT && captionWordCount === 0)}>
